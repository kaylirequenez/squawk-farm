...
PARTICLE_PARAMETERS = [
    ...
    {"name": "life_span", "label": "Lifespan", "min": 0.1, "max": 10, "step": 0.1},
    {
    ...
    {"name": "start_size", "label": "Start Size", "min": 0, "max": 100, "step": 1},
    {
    ...
    {"name": "end_size", "label": "End Size", "min": 0, "max": 100, "step": 1},
    {
    ...
    {"name": "emit_angle", "label": "Emit Angle", "min": 0, "max": 360, "step": 1},
    {
    ...
    {"name": "end_rotation", "label": "End Rotation", "min": 0, "max": 360, "step": 1},
    {
...
GRAVITY_EMITTER_PARAMETERS = [
    ...
    {"name": "speed", "label": "Speed", "min": 0, "max": 500, "step": 1},
    {"name": "speed_variance", "label": "Speed Var.", "min": 0, "max": 500, "step": 1},
    {"name": "gravity_x", "label": "Gravity X", "min": -500, "max": 500, "step": 1},
    {"name": "gravity_y", "label": "Gravity Y", "min": -500, "max": 500, "step": 1},
    {
...
RADIAL_EMITTER_PARAMETERS = [
    {"name": "max_radius", "label": "Max Radius", "min": 0, "max": 500, "step": 1},
    {
    ...
    {"name": "min_radius", "label": "Min Radius", "min": 0, "max": 500, "step": 1},
    # {
...
START_COLOR_PARAMETERS = [
    {"name": "start_color", "label": "R", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color", "label": "G", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color", "label": "B", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color", "label": "A", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color_variance", "label": "R", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color_variance", "label": "G", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color_variance", "label": "B", "min": 0, "max": 1, "step": 0.1},
    {"name": "start_color_variance", "label": "A", "min": 0, "max": 1, "step": 0.1},
]


END_COLOR_PARAMETERS = [
    {"name": "end_color", "label": "R", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color", "label": "G", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color", "label": "B", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color", "label": "A", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color_variance", "label": "R", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color_variance", "label": "G", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color_variance", "label": "B", "min": 0, "max": 1, "step": 0.1},
    {"name": "end_color_variance", "label": "A", "min": 0, "max": 1, "step": 0.1},
]
...
def format_config(particle):
  ...
  <rotationEndVariance value="{}"/>
    ...
    """.format(
        os.path.basename(particle.texture_path),
        particle.emitter_x,
        particle.emitter_y,
