...
class Screen(Widget):
    """
    :param globals: reference to the single globals object set in the :class:`ScreenManager` constructor. This is a static / class variable, so access it with ``Screen.globals``
    """
...
class ScreenManager(BaseWidget):
    ...
    def __init__(self, globals=None):
        ...
        :param globals: if set, this object will be made available to all screens as ``Screen.globals``.
        """
        ...
        # set globals on the Screen class (class variable)
